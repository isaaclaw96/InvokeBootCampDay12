...
// var amountClass = [ amountInput, amountInput2, amountInput3, amountInput4];

// var qtyClass = [ qtyInput, qtyInput2, qtyInput3, qtyInput4];
...
function validation(){
    ...
    var findTotal = listNode.querySelectorAll('p');
    var grandTotal = findTotal
}
